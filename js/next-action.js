...
(() => {
  function render() {
    ...
    card.innerHTML = !hasProgress ? '<b>Start here:</b> Take the resumable 20-question cold diagnostic. It unlocks your baseline, weak paths, and adaptive practice.' : !p.completedPretest ? '<b>Next best action:</b> Resume your diagnostic to complete the baseline.' : weak ? `<b>Next best action:</b> Retrain <button class="enginebtn secondary" data-weak="1">${weak.concept || weak.relation}</button>` : '<b>Next best action:</b> Start an adaptive practice set.';
