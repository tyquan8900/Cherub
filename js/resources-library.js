...
(() => {
  ...
  const official = {
    D1: { label:'NIST Cybersecurity Framework 2.0 — Govern function', url:'https://www.nist.gov/cyberframework' },
    D2: { label:'NIST SP 800-30 Rev. 1 — Guide for Conducting Risk Assessments', url:'https://csrc.nist.gov/pubs/sp/800/30/r1/final' },
    D3: { label:'NIST Cybersecurity Framework 2.0 — functions and profiles', url:'https://www.nist.gov/cyberframework' },
    D4: { label:'NIST SP 800-34 Rev. 1 — Contingency Planning Guide', url:'https://csrc.nist.gov/pubs/sp/800/34/r1/final' }
  };
